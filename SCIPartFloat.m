...
Features.StepHeightL(j+l,1)=FLOAT_NO_CRUTCHES.(trials{k}).GaitCycles.(numbers{j}).Kin.StepHeight.(all_sensors{2});
Features.StepHeightR(j+l,1)=FLOAT_NO_CRUTCHES.(trials{k}).GaitCycles.(numbers{j}).Kin.StepHeight.(all_sensors{6});
...
Features.ElevationKneeLmin(j+l,1)=min(FLOAT_NO_CRUTCHES.(trials{k}).GaitCycles.(numbers{j}).Kin.RightAngles.KneeElevAngle);
...
Features.JointAngleAnkleLmax(j+l,1)=max(FLOAT_NO_CRUTCHES.(trials{k}).GaitCycles.(numbers{j}).Kin.LeftAngles.AnkleElevAngle);
Features.JointAngleAnkleLmax(j+l,1)=max(FLOAT_NO_CRUTCHES.(trials{k}).GaitCycles.(numbers{j}).Kin.RightAngles.AnkleElevAngle);

Features.JointAngleAnkleLmin(j+l,1)=min(FLOAT_NO_CRUTCHES.(trials{k}).GaitCycles.(numbers{j}).Kin.LeftAngles.AnkleElevAngle);
Features.JointAngleAnkleLmin(j+l,1)=min(FLOAT_NO_CRUTCHES.(trials{k}).GaitCycles.(numbers{j}).Kin.RightAngles.AnkleElevAngle);
